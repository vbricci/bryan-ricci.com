...
import { Box, Button, CloseButton, Dialog, Portal, Text, useDisclosure } from "@chakra-ui/react";
...
const Timeline = ({ timeline, onRefresh, children = null }: ITimelineProps) => {
  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      ...
      <Dialog.Root open={open} onOpenChange={handleClose} size={'full'}>
        <Portal>
          <Dialog.Backdrop />
          <Dialog.Positioner>
            <Dialog.Content>
              ...
              <Dialog.Body>
                <TimelineMedia media={selected?.media ?? []} />
                {
